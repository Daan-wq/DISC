...
export default function AdminSettingsPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <section className="border rounded-lg p-6 bg-white space-y-4">
        <div>
          <h2 className="text-lg font-semibold mb-2">Twee-Factor Authenticatie (2FA)</h2>
          <p className="text-sm text-gray-600 mb-4">
        ...
        {is2FAEnabled ? (
          <div className="space-y-4">
            <div className="p-4 bg-green-50 border border-green-200 rounded-lg">
              <p className="text-green-800 font-medium">✅ 2FA is ingeschakeld op je account</p>
            </div>
            <button
                ...
                <div className="p-4 bg-gray-50 rounded-lg text-center">
                  ...
                  {totpSecret && (
                    <p className="text-xs text-gray-500 mt-3">
                      Handmatig: <code className="font-mono bg-white p-1 rounded">{totpSecret}</code>
                    </p>
                  )}
                </div>
