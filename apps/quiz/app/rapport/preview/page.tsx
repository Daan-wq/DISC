          ...
          <div className="mb-8 bg-green-50 border border-green-200 rounded-2xl p-6 flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-green-700 text-sm leading-relaxed">
                ...
                Klik op de knop onderaan om je volledige rapport te openen.
              </p>
            </div>
          </div>
                ...
                {isTrainerOnly ? (
                  ...
                  <>
                    <p className="text-slate-600 mb-6 leading-relaxed max-w-2xl mx-auto">
                      ...
                      en praktische aanbevelingen. Open het om direct te bekijken. We zullen het ook in uw mail versturen.
                    </p>
                        ...
                        <Button
                          ...
                          onClick={() => {
                            window.location.assign(
                              `/feedback?attempt_id=${encodeURIComponent(attemptId)}`
                            )
                          }}
                    ...
                    <p className="text-xs text-slate-400 mt-4">
                      De PDF wordt automatisch berekend en geopend.
                    </p>
                  </>
                )}
              </CardContent>
