      ...
      <div className="min-h-screen bg-gray-50 py-6 px-3 sm:py-8 sm:px-4 md:py-12">
        <div className="max-w-md mx-auto bg-white rounded-lg shadow p-4 sm:p-6 md:p-8 text-center">
          ...
          <div className="flex items-center justify-center gap-3 mb-4">
            ...
            <p className="text-sm sm:text-base text-gray-600">We verwerken je resultaten...</p>
          </div>
          <p className="text-sm sm:text-base text-gray-600">Je ontvangt een mail met je eindrapport.</p>
        </div>
      </div>
    )
  }
